...
; Generated by Chris Woodhouse on 10/11/2020 (UTC)
;
[Setup]
AppID={{087ccbe8-c4fe-4992-a66a-981bb4a5d50e}
AppName=ASCOM NanoSM SafetyMonitor Driver
AppVerName=ASCOM NanoSM SafetyMonitor Driver 1.5
AppVersion=1.4
...
OutputDir="."
OutputBaseFilename="NanoSM Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\SafetyMonitor\NanoSM"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\SafetyMonitor\NanoSM"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "E:\Visual Studio\Project files\Gizmo\Nano Safety Monitor\bin\Release\ASCOM.NanoSM.SafetyMonitor.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "E:\Visual Studio\Project files\Gizmo\Nano Safety Monitor\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.NanoSM.SafetyMonitor.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.NanoSM.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.NanoSM.SafetyMonitor.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.NanoSM.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.NanoSM.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
